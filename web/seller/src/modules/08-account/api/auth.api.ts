 ...
 * - GET  /api/users/me      当前卖家 profile 与权限
 *
...
export const authApi = {
   ...
   * 拉取当前卖家 profile 与权限
   */
  getProfile(): Promise<ProfileResultDto> {
    return client.get<ProfileResultDto>('/users/me').then((r) => r.data)
  },
   ...
   */
  logout(): Promise<void> {
    return client.post<void>('/auth/logout').then(() => undefined)
  },
}
