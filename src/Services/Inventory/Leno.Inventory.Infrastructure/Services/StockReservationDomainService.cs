...
/// 由 <c>StockReservationCompensationBackgroundService</c> 定期重试，保证库存最终被释放。
/// 迁移自 Order BC，更新命名空间与 InventoryDbContext 引用。
/// </summary>
public sealed class StockReservationDomainService : IStockReservationDomainService
{
    ...
    /// 补偿记录由 <c>StockReservationCompensationBackgroundService</c> 定期重试。
    /// </summary>
