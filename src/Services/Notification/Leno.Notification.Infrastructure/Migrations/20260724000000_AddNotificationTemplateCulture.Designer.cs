...
namespace Leno.Notification.Infrastructure.Migrations
{
    ...
    [Migration("20260724000000_AddNotificationTemplateCulture")]
    partial class AddNotificationTemplateCulture
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Leno.Notification.Domain.Aggregates.NotificationConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("Leno.Notification.Domain.Aggregates.NotificationRateLimitConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasIndex("Channel")
                        .IsUnique()
                        .HasDatabaseName("ix_notification_rate_limit_configs_channel");

                    b.ToTable("notification_rate_limit_configs", (string)null);
                });
            ...
            modelBuilder.Entity("Leno.Notification.Domain.Aggregates.NotificationRecord", b =>
                {
                    ...
                    b.HasIndex("UserId", "IsRead", "Channel")
                        .HasDatabaseName("ix_notification_records_user_isread_channel");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("UserId", "IsRead", "Channel"), new[] { "CreatedAt", "TemplateCode" });
            ...
            modelBuilder.Entity("Leno.Notification.Domain.Aggregates.NotificationTemplate", b =>
                {
                    ...
                    // DG-8 决策门通过后，同一 code+channel 可按 culture 维度创建多语言变体。
                    b.HasIndex("Code", "Channel", "Culture")
                        .IsUnique()
