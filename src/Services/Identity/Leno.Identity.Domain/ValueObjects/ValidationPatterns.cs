...
/// <summary>
/// 用户名格式校验模式，供 User 聚合与 RegisterDtoValidator 共享，消除 DRY 违反。
...
/// <summary>
/// 邮箱格式校验模式，供 User 聚合与 RegisterDtoValidator 共享，消除 DRY 违反。
/// 从 UserAuth BC 迁入 Identity BC（3.6 AuthN/AuthZ 拆分）。
/// </summary>
...
/// <summary>
/// 手机号格式校验模式（E.164），供 User 聚合与 RegisterDtoValidator 共享，消除 DRY 违反。
/// 从 UserAuth BC 迁入 Identity BC（3.6 AuthN/AuthZ 拆分）。
/// </summary>
