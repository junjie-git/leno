...
public sealed class BrowseHistoryController : UserCenterControllerBase
{
    ...
    /// <summary>记录浏览历史。幂等：5 秒内同一 SPU 仅更新 ViewedAt，不新增记录。</summary>
    [HttpPost]
    ...
    public async Task<IActionResult> RemoveAsync(Guid id, CancellationToken ct)
    {
        ...
        return Ok(ApiResponse.Success("已删除浏览记录"));
    }
