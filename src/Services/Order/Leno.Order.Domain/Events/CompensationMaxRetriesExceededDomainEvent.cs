...
/// <summary>
/// 库存预占回滚补偿记录达到最大重试次数仍失败领域事件（P1-T20）。
/// 由 <see cref="StockReservationCompensation.MarkFailed"/> 在状态流转到
/// <see cref="CompensationStatus.MaxRetriesExceeded"/> 时收集，上报告警供运维人工介入。
/// mapper 可翻译为集成事件对接告警通道（短信/邮件/IM）。
/// </summary>
