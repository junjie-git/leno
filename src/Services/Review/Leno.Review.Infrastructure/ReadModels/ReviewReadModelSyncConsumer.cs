...
/// 在评价生命周期事件（提交/审核通过/隐藏）时将评价聚合同步索引到 Elasticsearch reviews_v2 索引。
...
{
    // 评价 BC 独立 ES 索引名，加 _v2 后缀以与旧 ReviewAfterSales BC 的 reviews 索引区分
    private const string IndexName = ReviewIndexInitializer.IndexName;
