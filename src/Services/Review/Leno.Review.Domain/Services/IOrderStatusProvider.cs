...
/// <summary>
/// 订单状态查询防腐层接口（M4 双轨方案抽取，评价 BC 独立维护）。
/// 仅负责远程查询订单状态，业务规则校验由 <see cref="IReviewEligibilityChecker"/> 实现。
...
/// <summary>订单状态概要信息（M4 双轨方案抽取，评价 BC 独立维护）。</summary>
...
/// <summary>订单行状态概要（M4 双轨方案抽取，评价 BC 独立维护）。</summary>
