...
namespace Leno.PointsMembership.Infrastructure.Services;
...
/// 抵扣换算：100 积分 = 1 元。
/// </summary>
public sealed class EfCorePointsOffsetService : IPointsOffsetService
{
    ...
    public EfCorePointsOffsetService(
