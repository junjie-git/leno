...
│ 2   银卡会员  1000   0.95 95折+生日礼 启用 [编辑][停用]│
│ 3   金卡会员  5000   0.9  9折+专属客服 启用 [编辑][停用]│
│ 4   钻石会员  20000  0.85 85折+VIP   启用 [编辑][停用]│
└──────────────────────────────────────────────────┘
```
...
- **等级色**：普通 `#8C8C8C`、银卡 `#8C8C8C`、金卡 `#FAAD14` 金、钻石 `#722ED1` 紫（等级图标区分）。
